...
catalogo = Catalogo(host='damrol.mysql.pythonanywhere-services.com', user='damrol', password='CodoaCodo2024', database='damrol$miapp')
...
RUTA_DESTINO = '/home/damrol/mysite/static/imagenes'
